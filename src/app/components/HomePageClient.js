...
/**
 * Home page client component with all interactive features
 * @returns {JSX.Element} Home page client component
 */
export default function HomePageClient() {
    ...
    useEffect(() => {
        ...
        Object.assign(websiteScript, createStructuredDataScript(websiteData));
